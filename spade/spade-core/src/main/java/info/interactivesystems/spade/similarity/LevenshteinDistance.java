...
public class LevenshteinDistance implements SimilarityCalculator {
	...
	/**
	 * Calculates the Levenshtein distance for two given Strings. The shorter
	 * the distance, the more similar the sentences. This is useful for small
	 * changes in individual sentences, i.e. typing errors.
	 * 
